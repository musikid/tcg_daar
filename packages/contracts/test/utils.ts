import type { TransferEvent } from '../typechain-types/@openzeppelin/contracts/token/ERC721/IERC721'
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog } from '../typechain-types/common'

interface FiltersTransfer {
  filters: {
